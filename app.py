...
if app_mode == 'Introduction':
    ...
    st.info("The target audience for this application are companies, developers and individuals who are interested in analyzing the sleep quality in an individual.")
...
##############
    ...
    st.write(f"Total emissions: {(round(emissions,10))} kg")
