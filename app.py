...
#############
    ...
    col3.markdown(f'<div style="{box_style}"><strong>REM Sleep Percentage</strong><br><br>Percentage of rapid eye movement sleep. The higher, the better.<br>Ex: Bachelors</div>', unsafe_allow_html=True)
