...
#############
    ...
    col9.markdown(f'<div style="{box_style}"><strong>Blood Pressure Lower Value</strong><br><br>Pressure in arteries when the heart rests.</div>', unsafe_allow_html=True)
