...
#############
    ...
    col8.markdown(f'<div style="{box_style}"><strong>Blood Pressure Upper Value</strong><br>Pressure in arteries when the heart beats.</div>', unsafe_allow_html=True)
    col9.markdown(f'<div style="{box_style}"><strong>Blood Pressure Lower Value</strong><br>Pressure in arteries when the heart rests.</div>', unsafe_allow_html=True)
